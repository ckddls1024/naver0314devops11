...
public class Ex8_string {
	...
	public static void main(String[] args) {
		...
		String str1="Have Nice Day";
		String str2="apple";
		String str3="Apple";
		
		System.out.println(str1.charAt(7));//7번의 인덱스의 문자 : N
		System.out.println(str1.charAt(0));//0번의 인덱스의 문자 : H
		...
		System.out.println(str1.substring(7, 11));//7번부터 10까지 추출 : Nice
		...
		System.out.println(str1.endsWith("Day"));//str1이 Day로 끝날경우 true : true
		System.out.println(str1.endsWith("day"));//str1이 day로 끝날경우 true : false
		System.out.println(str1.toLowerCase().endsWith("day"));//str1을 소문자로 변환 후 Day로 끝날경우 true : true
		...
		//일부변경
		System.out.println(str1.replace('a', '*'));//a문자를 8로 변경 : H*ve Nice D*y
		...
		//분리된 토큰값 출력
		while(st.hasMoreTokens())//더이상 토큰이 없을 경우 false가 되면서 whlie을 빠져나간다
		{
			System.out.println(st.nextToken());//다음 토큰 꺼내서 출력
		}
		
		String msg="    hello    ";
		System.out.println(msg.length()+"글자");//13글자
		System.out.println(msg.trim().length()+"글자");//양쪽 공백 제거후 5글자
